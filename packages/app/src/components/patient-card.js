...
let PatientCard = class PatientCard extends LitElement {
    constructor() {
        // PUBLIC PROPERTIES
        super(...arguments);
    ...
    renderCharts() {
        ...
        const usage = this.dataUsage.length >= 156
    ...
    render() {
        ...
        const untilText = info.mode === "temporary" && info.expiresAt
...
__decorate([
    property({ type: Array })
], PatientCard.prototype, "dataUsage", void 0);
__decorate([
    property({ type: Object })
], PatientCard.prototype, "dataShareinfo", void 0);
__decorate([
    state()
], PatientCard.prototype, "isExpanded", void 0);
PatientCard = __decorate([
