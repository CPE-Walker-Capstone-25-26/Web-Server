...
let ShareFormCard = class ShareFormCard extends LitElement {
    constructor() {
        super(...arguments);
    ...
    submitForm(e) {
        ...
        this.dispatchEvent(new CustomEvent("share-submit", {
            detail: {
...
__decorate([
    state()
], ShareFormCard.prototype, "withUserId", void 0);
__decorate([
    state()
], ShareFormCard.prototype, "mode", void 0);
__decorate([
    state()
], ShareFormCard.prototype, "expiresAt", void 0);
ShareFormCard = __decorate([
    customElement("share-form-card")
], ShareFormCard);
export { ShareFormCard };
